            ...
            <div className=" bg-gradient-to-r from-green-700 to-black max-w-screen-xl mx-auto">
                <div className=" flex justify-around flex-col-reverse items-center  md:flex-row py-20">
                    <div className=" max-w-2xl lg:max-w-3xl p-20">
                        <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight  md:text-3xl lg:text-4xl text-white ">
                            Welcome to{" "}
                            <span className="text-green-500">green Ed </span>:
                            Your Guide to Understanding Climate Change
                        </h1>
                        <div className=" w-11/12 h-1 rounded bg-gray-300 mb-3"></div>
                        <p className="text-md font-normal lg:text-xl text-gray-300">
            ...
            <div className=" bg-white max-w-screen-xl mx-auto">
                <div className=" flex justify-around flex-col items-center  md:flex-row py-20 ">
                    ...
                    <div className=" max-w-2xl lg:max-w-3xl p-20 border-l-4">
                        <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight  md:text-3xl lg:text-4xl text-gray-800 ">
                            Understanding Climate{" "}
                            <span className="text-orange-500">Change</span>
                        </h1>
                        <div className=" w-11/12 h-1 rounded bg-gray-900 mb-3"></div>
                        <p className="text-md font-normal lg:text-xl text-gray-600">
                        ...
                        <div className=" mt-4">
                            <Link
                                href="./effect"
                                className="focus:outline-none text-white bg-orange-600 hover:bg-orange-800 focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-900  cursor-pointer"
                            >
                                Know More
                            </Link>
                        </div>
            ...
            <div className=" bg-gradient-to-r from-black to-black max-w-screen-xl mx-auto">
                <div className=" flex justify-around flex-col-reverse items-center  md:flex-row py-20">
                    <div className=" max-w-2xl lg:max-w-3xl p-20 border-red-700 border-r-4">
                        <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight  md:text-3xl lg:text-4xl text-gray-300 ">
                            {" "}
                            <span className="text-red-500">Impact </span>
                            Of Climate Change
                        </h1>
                        <div className=" w-11/12 h-1 rounded bg-gray-300 mb-3"></div>
                        <p className="text-md font-normal lg:text-xl text-gray-500">
                            Climate change significantly affects global
                            temperatures, biodiversity, and weather patterns. It
                            leads to sea-level rise, causing displacement and
                            habitat loss. It increases the frequency of extreme
                            weather events like hurricanes and droughts, posing
                            threats to infrastructure and lives. Climate change
                            also disrupts ecosystems, endangering species,
                            affects human health, exacerbates social
                            inequalities, and carries serious economic
                            consequences.
                        </p>
                        <div className=" mt-4">
                            <Link
                                href="./impact"
                                className="focus:outline-none text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900  cursor-pointer"
                            >
                                Know More
                            </Link>
                        </div>
            ...
            <div className=" bg-gradient-to-r from-green-500 to-white max-w-screen-xl mx-auto">
                <div className=" flex justify-around items-center flex-col  md:flex-row py-20">
                    ...
                    <div className=" max-w-2xl lg:max-w-3xl p-20 border-green-700 border-l-4">
                        <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight  md:text-3xl lg:text-4xl text-gray-700 ">
                            Climate Change{" "}
                            <span className="text-green-700">Solutions</span>
                        </h1>
                        <div className=" w-11/12 h-1 rounded bg-gray-900 mb-3"></div>
                        <p className="text-md font-normal lg:text-xl text-gray-600">
                            The road to a sustainable future is a collective
                            journey. Green Ed doesn't just stop at informing; we
                            aim to inspire. We provide practical, science-backed
                            solutions that individuals, communities, and
                            governments can implement to mitigate the impact of
                            climate change. Explore strategies spanning from
                            reducing carbon footprint and adopting renewable
                            energy to supporting sustainable policies and
                            practices.
                        </p>
                        <div className=" mt-4">
                            <Link
                                href="./solution"
                                className="focus:outline-none text-white bg-green-600 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-900  cursor-pointer"
                            >
                                Know More
                            </Link>
                        </div>
