                    ...
                    <div className=" flex justify-around flex-col items-center  md:flex-row py-20">
                        ...
                        <div className=" max-w-2xl lg:max-w-3xl p-20 border-gray-400 border-l-4 ">
                            <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-3xl lg:text-4xl dark:text-white ">
                                <span className="text-black dark:text-amber-700">
                                    Deforestation{" "}
                                </span>
                                and Climate Change
                            </h1>
                            ...
                            <p className="text-md font-normal text-gray-500 lg:text-xl dark:text-gray-300">
                                Deforestation contributes significantly to
                                climate change, as trees absorb CO2, a major
                                greenhouse gas. When trees are cut down or
                                burned, stored carbon is released back into the
                                atmosphere, exacerbating global warming.
                                Furthermore, by reducing forest cover, we lose
                                crucial habitats and biodiversity. To combat
                                climate change effectively, it's critical to
